...
class Result(object):
    ...
    @staticmethod
    def _from_feed_entry(entry: feedparser.FeedParserDict, verbose: bool = False) -> Result:
        """
    ...
    @staticmethod
    def _get_pdf_url(links: List[Link], verbose: bool = False) -> str:
        """
...
class Client(object):
    ...
    def _results(
        self, search: Search, offset: int = 0, verbose: bool = False,
    ...
    def _parse_feed(
        self, url: str, first_page: bool = True, _try_index: int = 0, verbose: bool = False,
